...
public class ArrayListeCmpTest {
	...
	private ArrayListeCmp<String> makeArrayListe(){
		ArrayListeCmp<String> liste = new ArrayListeCmp<>();			liste.hinzufuegen("elementB");
